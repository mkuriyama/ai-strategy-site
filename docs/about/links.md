---
description: AI戦略実践プロジェクトの関連サイト一覧。公開ライブラリー、主催会社、参加者向けのメンバーサイト。
---

# 関連リンク

プロジェクトに関わる場所をまとめています。**参加をご検討の段階で読む必要はありません**
（申し込みに必要な情報は[参加費とお申し込み](../join/index.md)にすべて書いてあります）。
参加後に使う場所と、主催者についての情報です。
...
セッションの間をつなぐ場所です。挑戦ボードへの記録の持ち寄り、資料の共有、
参加者同士のやりとりはここで行っています。**参加者向けのため、ログインが必要です。**

- **[メンバーサイト](https://ai-community.antecanis.com/){ target="_blank" rel="noopener" }** — 要ログイン

## 主催

- **[株式会社アンテカニス](https://www.antecanis.com/){ target="_blank" rel="noopener" }** — 本プロジェクトの主催会社
