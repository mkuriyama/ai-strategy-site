---
description: 第1回（メイン回・5/26）ダイジェスト：人間の認知容量の解除 ──情報×AIの戦略インパクト。
search:
...
第1回（パイロット・無償開催）のメイン回（5/26）では、参加者の皆さまご自身の手でAIを
動かしながら、「AI×戦略×実践」の最初の一歩 ―― 人間の認知容量の解除 ―― を体感して
いただきました。当日参加できなかった方、途中から参加された方に、その全体の流れをお届けします。
...
!!! info "第1回には追加開催（6/15）があります"
    第1回は、**メイン回（5/26）** と、その内容を一部改良した **追加開催（6/15）** の2回を実施しました。
    こちらは **メイン回（5/26）** のダイジェストです。改良版（産業転換の具体例などを追加）は
    **[Vol.1B 第1回（追加開催・6/15）](vol-01b.md)** をご覧ください。
...
{{ footer_cta("[追加開催（6/15）のダイジェスト](vol-01b.md)", "[ダイジェスト一覧](index.md)", "[月次テーマ](../sessions/themes.md)") }}
