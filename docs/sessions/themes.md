...
### 第4回（開催済）：物理世界との接地 ——Sense→Think→Actと、「簡単に作れる」時代の競争優位

航空写真をAIが読み進めて候補地を探す「AIロケーションファインダー」と、住まいの写真32枚×カタログ
860点から提案を組み立てる「AIライフスタイルデザイナー」。物理世界の情報（画像・地理データ）をAIが
認識し判断する体験を通じて、**誰でも簡単に作れる時代に、競争優位はどこに宿るのか**を架空企業の
ストーリーで考えました。

→ **[第4回ダイジェスト（A日程・8/18）](../digests/vol-04.md)** ／
**[（B日程・9/3）](../digests/vol-04b.md)** で当日の流れをご覧いただけます。

### 第3回（開催済）：AI戦略 × 組織レイヤー ——組織の「知」と「人」を、AIで流し・結び・配分し直す

暗黙知の表出化（SECIモデルのAI加速）、人材100名×求人60名の意味マッチング、集合知をリアルタイムに
構造化するAIアプリ、そして「250名分の仕事が浮く」設定で利害の衝突に向き合うAI人材戦略デザイン
ゲーム。実装（第1回）・戦略転換（第2回）に続き、**組織変革レイヤー**まで実地で扱いました。
追加開催（8/3）では、毎月の**挑戦セット・挑戦ボード**の共有と、締めくくりに「AIで競争優位の源泉は
どう変わるか」を全員で考える戦略ディスカッションを新たに加えています。

→ **[第3回ダイジェスト（A日程・7/21）](../digests/vol-03.md)** ／
**[（B日程・8/3）](../digests/vol-03b.md)** で当日の流れをご覧いただけます。
