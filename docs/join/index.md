...
<path d="M 398 304 L 398 246 L 518 246 L 518 188 L 638 188 L 638 130 L 748 130" fill="none" stroke="#1C6E7C" stroke-width="2.2" stroke-dasharray="7 5" opacity="0.55" stroke-linejoin="round"/>
...
<line x1="158" y1="362" x2="748" y2="362" stroke="#004455" stroke-width="2.4" opacity="0.55"/>
<line x1="158" y1="304" x2="748" y2="304" stroke="#004455" stroke-width="3.4"/>
<circle cx="278" cy="304" r="7.5" fill="#C0962F" stroke="#FFFFFF" stroke-width="2"/>
<rect x="264" y="126" width="220" height="40" rx="9" fill="#F5ECD3" stroke="#E0C77E" stroke-width="1.3"/>
<text x="274" y="143" font-size="12" font-weight="700" fill="#C0962F">いまここ：現在の早期参加枠</text>
<text x="274" y="160" font-size="11.5" fill="#003A47">当面 ¥6,300／月 のまま</text>
<line x1="278" y1="166" x2="278" y2="296" stroke="#C0962F" stroke-width="1.4" stroke-dasharray="3 3" opacity="0.7"/>
<text x="744" y="294" text-anchor="end" font-size="12.5" font-weight="700" fill="#004455">お申し込み済みの方は据え置き</text>
...
<figcaption>図2：早期参加枠は「申込時の月額が据え置き」になります。後から申し込む方ほど、月額は段階的に上がっていく想定です。</figcaption>
</figure>
...
決済は、クレジットカード等を利用できる **Stripe** で行います（**カード情報は弊社で保持しません**）。
インボイス番号付きの**適格請求書・領収書をPDFで取得**でき、勤務先等での経費処理にご利用
いただけます。
...
!!! info "メール配信について"
    ...
    いつでもご自身でキャンセルできます（オンライン会場のZoom情報・当日資料は、お申し込み後に
    ご案内します）。

## 法人でのご利用

一定人数以上でのご利用は、お見積書の発行・請求書払い・個別開催（費用別途）にも対応します。
詳しくは **[法人の方へ](corporate.md)** をご覧ください。お見積りのご相談は
[support@antecanis.com](mailto:support@antecanis.com) までどうぞ。
