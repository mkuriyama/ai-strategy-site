...
決めている方は **[お申し込み](#お申し込み)** から、そのままお進みください。
...
内容をご存知の方・参加を決めた方は、そのままお申し込みいただけます。お申し込みの前に、上記の
3点（申込月は無料／課金は毎月15日／前日までの解約でその月は¥0）をご確認ください。

{{ join_button("今すぐ申し込む（申込月無料）") }}

お申し込み後に、オンライン会場（Zoom）情報・当日資料と、参加者コミュニティ（Circle）への
ご招待をお送りします（会場リンク・資料は主に Circle 内でご案内します）。Circleでの
